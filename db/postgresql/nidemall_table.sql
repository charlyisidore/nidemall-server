...
CREATE TABLE "nidemall_admin" (
  ...
  "last_login_time" timestamp DEFAULT NULL, -- 最近一次登录时间
...
CREATE TABLE "nidemall_cart" (
  "id" SERIAL,
  "user_id" int DEFAULT NULL, -- 用户表的用户ID
  "goods_id" int DEFAULT NULL, -- 商品表的商品ID
  "goods_sn" varchar(63) DEFAULT NULL, -- 商品编号
  "goods_name" varchar(127) DEFAULT NULL, -- 商品名称
  "product_id" int DEFAULT NULL, -- 商品货品表的货品ID
...
CREATE TABLE "nidemall_collect" (
  "id" SERIAL,
  "user_id" int NOT NULL DEFAULT '0', -- 用户表的用户ID
  "value_id" int NOT NULL DEFAULT '0', -- 如果type=0，则是商品ID；如果type=1，则是专题ID
...
CREATE TABLE "nidemall_comment" (
  "id" SERIAL,
  "value_id" int NOT NULL DEFAULT '0', -- 如果type=0，则是商品评论；如果是type=1，则是专题评论。
...
CREATE TABLE "nidemall_coupon" (
  ...
  "goods_type" smallint DEFAULT '0', -- 商品限制类型，如果0则全商品，如果是1则是类目限制，如果是2则是商品限制。
  "goods_value" varchar(1023) DEFAULT '[]', -- 商品限制值，goods_type如果是0则空集合，如果是1则是类目集合，如果是2则是商品集合。
  "code" varchar(63) DEFAULT NULL, -- 优惠券兑换码
  "time_type" smallint DEFAULT '0', -- 有效时间限制，如果是0，则基于领取时间的有效天数days；如果是1，则start_time和end_time是优惠券有效期；
  "days" smallint DEFAULT '0', -- 基于领取时间的有效天数days。
  "start_time" timestamp DEFAULT NULL, -- 使用券开始时间
...
CREATE TABLE "nidemall_coupon_user" (
  ...
  "used_time" timestamp DEFAULT NULL, -- 使用时间
  "start_time" timestamp DEFAULT NULL, -- 有效期开始时间
  "end_time" timestamp DEFAULT NULL, -- 有效期截至时间
...
CREATE TABLE "nidemall_goods" (
  ...
  "category_id" int DEFAULT '0', -- 商品所属类目ID
...
CREATE TABLE "nidemall_goods_attribute" (
  "id" SERIAL,
  "goods_id" int NOT NULL DEFAULT '0', -- 商品表的商品ID
...
CREATE TABLE "nidemall_groupon" (
  ...
  "groupon_id" int DEFAULT '0', -- 如果是开团用户，则groupon_id是0；如果是参团用户，则groupon_id是团购活动ID
  "rules_id" int NOT NULL, -- 团购规则ID，关联nidemall_groupon_rules表ID字段
  "user_id" int NOT NULL, -- 用户ID
  "share_url" varchar(255) DEFAULT NULL, -- 团购分享图片地址
  "creator_user_id" int NOT NULL, -- 开团用户ID
  "creator_user_time" timestamp DEFAULT NULL, -- 开团时间
...
CREATE TABLE "nidemall_groupon_rules" (
  "id" SERIAL,
  "goods_id" int NOT NULL, -- 商品表的商品ID
  "goods_name" varchar(127) NOT NULL, -- 商品名称
  "pic_url" varchar(255) DEFAULT NULL, -- 商品图片或者商品货品图片
  "discount" decimal(63,0) NOT NULL, -- 优惠金额
  "discount_member" int NOT NULL, -- 达到优惠条件的人数
  "expire_time" timestamp DEFAULT NULL, -- 团购过期时间
...
CREATE TABLE "nidemall_notice_admin" (
  "id" SERIAL,
  "notice_id" int DEFAULT NULL, -- 通知ID
  "notice_title" varchar(63) DEFAULT NULL, -- 通知标题
  "admin_id" int DEFAULT NULL, -- 接收通知的管理员ID
...
CREATE TABLE "nidemall_order" (
  "id" SERIAL,
  "user_id" int NOT NULL, -- 用户表的用户ID
  "order_sn" varchar(63) NOT NULL, -- 订单编号
  "order_status" smallint NOT NULL, -- 订单状态
  "aftersale_status" smallint DEFAULT '0', -- 售后状态，0是可申请，1是用户已申请，2是管理员审核通过，3是管理员退款成功，4是管理员审核拒绝，5是用户已取消
  ...
  "refund_time" timestamp DEFAULT NULL, -- 退款时间
  "confirm_time" timestamp DEFAULT NULL, -- 用户确认收货时间
...
CREATE TABLE "nidemall_order_goods" (
  "id" SERIAL,
  "order_id" int NOT NULL DEFAULT '0', -- 订单表的订单ID
  "goods_id" int NOT NULL DEFAULT '0', -- 商品表的商品ID
  "goods_name" varchar(127) NOT NULL DEFAULT '', -- 商品名称
  "goods_sn" varchar(63) NOT NULL DEFAULT '', -- 商品编号
  "product_id" int NOT NULL DEFAULT '0', -- 商品货品表的货品ID
...
CREATE TABLE "nidemall_user" (
  ...
  "user_level" smallint DEFAULT '0', -- 0 普通用户，1 VIP用户，2 高级VIP用户
